					...
					<div className="right d-flex align-items-center">
						<ul className="social-section d-inline-flex parallel-border">
							<li className="social-icon">
								<a href="https://twitter.com/dogecapitaldc" target="_blank">
									<FaTwitter />
								</a>
							</li>
							<li className="social-icon">
								<a href="https://t.me/dogecapitalportal" target="_blank">
										<FaTelegramPlane />
								</a>
							</li>
							<li className="social-icon">
								<a href="https://t.me/dogecapitalofficial" target="_blank">
										<FaBullhorn />
								</a>
							</li>
							<li className="social-icon">
								<a href="https://github.com/Dogecapitalventures" target="_blank">
										<FaGithub />
								</a>
							</li>
						</ul>
						...
						<div className="left">
						<Link to={DASHBOARD}><div className="mb-0">POMF</div></Link>
					</div>
					</div>
				</div>
		</div>
