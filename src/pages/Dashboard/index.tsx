...
import DDCP from "../../config/contract/abi/DDCP.json";
...
const Dashboard = () => {
  ...
  const {REACT_APP_DEPLOYED_CONTRACT, REACT_APP_TREASURY_WALLET, REACT_APP_RPC_DOGICHAIN, REACT_APP_POOL_VALUE, REACT_APP_DCP_INSURANCE, REACT_APP_FIREPIT} = process.env;
...
// const signer = provider.getSigner()
  ...
  let fireDcp = await contract?.balanceOf(REACT_APP_FIREPIT as string)
  ...
  let wdoge = parseFloat(priceUsd.data.pair.priceUsd)*((parseFloat(wdog)/1000000000000000000) as any)
  setTreasurayAsset((dcpblU+wdoge).toString())
      ...
      <ToastContainer />
        <div className="col-lg-4 col-md-12 d-flex justify-content-end flex-column left align-items-center">
          ...
          <div className="card parallel-border-lr mx-2">
            ...
            <div className="card-value">{formatter.format(parseInt( String(Number(totalSupply) / 100000)))?.slice(-7)}</div>
          </div>
          <div className="card parallel-border-lr mx-2">
            <div className="card-title-regular">Circulating Supply</div>
            <div className="card-value">{formatter.format(parseInt( String(Number(crSupply) / 100000)))?.slice(-7)}</div>
          </div>
        </div>
        <div className="col-lg-4 col-md-12 middle d-flex flex-column justify-content-center align-items-center">
          <div className="d-flex align-items-center justify-content-center flex-column">
            <div className="btn--outline card parallel-border-lr">
              DCP PRICE
            <div className="card-value">${dcpPrice}</div>
            </div>
        ...
        <div className="col-lg-4 col-md-12 d-flex justify-content-end flex-column left align-items-center">
          <div className="mx-2 card parallel-border-lr mb-4">
            <div className="card-title-regular">DCP Insurance Fund Value</div>
      ...
      <div className="row bottom mt-2">
        <div className="col-lg-4 col-md-12 d-flex justify-content-end flex-column left align-items-center">
          {/* <div className="card parallel-border">
            ...
            <div className="card-value">5,765,134.72 DCP</div>
          </div> */}
        </div>
